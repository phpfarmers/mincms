 ...
 * @return boolean
 */
include realpath(__DIR__."/../../../..")."/cronjob/bootstrap.php";

$cid = Cookie::get('id');
$sid = Session::get('id');
$gid = strtolower(Cookie::get('guest')); 
...
*/
if($cid){
	$baseUrl = '/upload_files/user/'.$cid."/";
}elseif($sid){
	$baseUrl = '/upload_files/admin/'.$cid."/";	
}else{
	$baseUrl = '/upload_files/default/'.$gid."/";	
}
/*
