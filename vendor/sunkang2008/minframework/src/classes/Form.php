...
* 该类主要服务于Node以及Drupal
* Form::open();
* Form::input($key,$value,$options=[])
* Form::text($key,$value,$options=[])
* Form::file($key,$value,$options=[])
* Form::image($key,$value,$options=[])
* Form::password($key,$value,$options=[])
* Form::label($key,$value,$options=[])
* Form::html($key,$value,$options=[])
* Form::checkboxs($key,$value,$options=[])
* Form::checkboxs($key,$value,$options=[]) 
* echo Form::select($key,['option'=>$option]);
* </code>
*/
class Form
{  
